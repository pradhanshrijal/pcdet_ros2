...
# Install pcdet_ros2
cd ${IN_SSI_PATH}/git_pkgs/ros_pkgs/pcdet_ws
...
# Install OpenPCDet
python3 -m pip install -r ${IN_SSI_PATH}/git_pkgs/ros_pkgs/pcdet_ws/src/pcdet_ros2/requirements/python_venv_requirements.txt
